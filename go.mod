...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/drainprocessor v0.158.0
...
// OBI integration. `go.opentelemetry.io/obi v0.9.0` lives in the
